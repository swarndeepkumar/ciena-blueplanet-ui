...
@Component({
  ...
  animations: [
      trigger('visibilityChanged', [
        ...
        transition(':leave', [  // leave is alias to d
...
export class MenuItemComponent implements OnInit {
  ...
  onClick(event) : void {
    ...
    if (this.item.submenu) {
      ...
      // force horizental menus to close by sending a mouseleave event.
  ...
  onPopupMouseEnter(event) : void {
    console.log('called onPopupMouseEnter...');
    if(!this.menuService.isVertical){
      console.log('called mouseInPopuptrue...');
